...
the [trending](https://CRAN.R-project.org/package=trending) package. Whilst it
...
- The *trendeval* project on *github*, useful for developers, contributors, and
users wanting to post issues, bug reports and feature requests: <br>
<https://github.com/reconhub/trendeval>
